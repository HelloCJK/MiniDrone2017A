...
expect "RS.edu] \$ ";
send "sed -i \"s/POWERGAIN : \[1-10\]\[0-10\]*;/POWERGAIN : 100;/\" /data/edu/params/paramsEDU.dat\r";
expect "RS.edu] \$ ";
send "sed -i \"s/FEAT_TEST : \[1-10\]\[0-10\]*;/FEAT_TEST : 0;/\" /data/edu/params/paramsEDU.dat\r";
expect "RS.edu] \$ ";
